...
main proc far
    ...
    ing:
       ...
       MOV HOTY ,AL
       JMP L
       ;here we should write code to insure that number you enter must be 1,or ,2 not other
       ; problem here :loop work till 4
       L:
  ...
  dmp: 
       ...
       ;here we should write code to insure that number you enter must be 1,or ,2 or 3 not other
       ;problem :work till 4 
